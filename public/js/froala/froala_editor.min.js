...
! function (a) {
    ...
    b.count = 0, b.VALID_NODES = ["P", "PRE", "BLOCKQUOTE", "H1", "H2", "H3", "H4", "H5", "H6", "DIV", "LI", "TD"], b.LANGS = [], b.DEFAULTS = {
        ...
        borderColor: "#252528",
        buttons: ["bold", "italic", "underline", "strikeThrough", "color", "sep", "formatBlock", "blockStyle", "align", "insertOrderedList", "insertUnorderedList", "outdent", "indent", "sep", "createLink", "insertImage", "insertVideo", "insertHorizontalRule", "undo", "redo", "html"],
        crossDomain: !0,
        customButtons: {},
        customDropdowns: {},
        customText: !1,
        ...
        this.sync(), this.$bttn_wrapper && (this.$bttn_wrapper.html("").remove(), this.$bttn_wrapper.html("").removeData()), this.$editor && (this.$editor.html("").remove(), this.$editor.html("").removeData()), this.$element.blur(), this.$image_editor && (this.$image_editor.html("").remove(), this.$image_editor.removeData()), this.$image_wrapper && (this.$image_wrapper.html("").remove(), this.$image_wrapper.removeData()), this.$link_wrapper && (this.$link_wrapper.html("").remove(), this.$link_wrapper.removeData()), this.$video_wrapper && (this.$video_wrapper.html("").remove(), this.$video_wrapper.removeData()), this.$popup_editor && (this.$popup_editor.html("").remove(), this.$popup_editor.removeData()), this.$overlay && (this.$overlay.html("").remove(), this.$overlay.removeData()), this.$image_modal && (this.hideMediaManager(), this.$image_modal.html("").remove(), this.$image_modal.removeData()), this.isLink ? this.$element.removeData("fa.editable") : (this.$element.replaceWith(this.getHTML()), this.$box && (this.$box.removeClass("froala-box"), this.$box.find(".html-switch").remove(), this.$box.removeData("fa.editable"), clearTimeout(this.typingTimer))), clearTimeout(this.ajaxInterval), clearTimeout(this.typingTimer), this.$element.off("mousedown mouseup click keydown keyup focus keypress touchstart touchend touch drop"), this.$element.off("mousedown mouseup click keydown keyup focus keypress touchstart touchend touch drop", "**"), a(window).off("mouseup." + this._id), a(window).off("keydown." + this._id), a(window).off("keyup." + this._id), a(window).off("hide." + this._id), a(window).off("scroll." + this._id), a(document).off("selectionchange." + this._id), void 0 !== this.$upload_frame && this.$upload_frame.remove(), this.$textarea && (this.$box.remove(), this.$textarea.removeData("fa.editable"), this.$textarea.show())
        ...
        var c;
        if (b)
            for (c = a.replace(/<span((?!id\s*=\s*["']?marker-[^>]+)[^>])*?><\/span>/g, ""); a != c;) a = c, c = a.replace(/<span((?!id\s*=\s*["']?marker-[^>]+)[^>])*?><\/span>/g, "");
        else
        ...
        var b = [],
            ...
            e = function () {
                if (0 != b.length) {
                    ...
                    var e = a(b[0]);
                    if (1 == b.length && ("marker-false" === e.attr("id") || "marker-true" === e.attr("id"))) return void(b = []);
        ...
        this.$element.get(0).onpaste = function () {
            if (!b.isHTML) {
                ...
                c.focus(), window.setTimeout(function () {
                    var e = c.html();
                    c.remove(), a(window).scrollTop(d), b.restoreSelection(), b.insertHTML(b.options.plainPaste ? a("<div>").html(e).text() : b.clean(e, !1, !0)), b.sync(), b.$element.trigger("placeholderCheck"), b.pasting = !1, b.callback("afterPaste")
                }, 1)
            }
        }
        ...
        if (this.isEnabled("undo") || this.isEnabled("redo")) {
            ...
            if (this.undoStack[this.undoIndex - 1] && this.undoStack[this.undoIndex - 1].replace('<span id="marker-false"></span>', "").replace('<span id="marker-true"></span>', "") == a) return !1;
        ...
        if (void 0 == a && (a = !0), !this.isHTML && (a && this.$element.focus(), "" === this.text())) {
            ...
            if (e.length >= 1 && e[0] != this.$element.get(0))
                for (var c = 0; c < e.length; c++)
                    if (d = e[c], !this.textEmpty(d)) return void this.setSelection(d, 0, null, 0);
        ...
        a(window).on("hide." + this._id, a.proxy(function () {
            ...
            if (d) {
                ...
                if (13 == c && e.hasClass("f-img-wrap")) {
                    var f = a("<p><br/></p>");
                    return 1 == d.startOffset ? e.closest(a.Editable.VALID_NODES.join(",")).after(f) : 0 == d.startOffset && e.closest(a.Editable.VALID_NODES.join(",")).before(f), this.setSelection(f.get(0), 0, null, 0), this.sync(), !1
                }
                if (8 == c) {
                    var g = null;
        ...
        return this.options.enableScript ? a : /^https?:\/\//.test(a) ? String(a).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;") : encodeURIComponent(a).replace(/%23/g, "#").replace(/%2F/g, "/").replace(/%25/g, "%").replace(/%3A/g, ":").replace(/%3F/g, "?").replace(/%3D/g, "=").replace(/%26/g, "&").replace(/%40/g, "@")
    ...
    a.fn.editable = function (c) {
        ...
        return a.getRangeAt && a.rangeCount ? a.getRangeAt(0) : document.createRange ? document.createRange() : null
        ...
        if (!this.selectionDisabled) {
            ...
            b.length > 0 && a.length > 0 && (this.$element.focus(), this.setSelection(a[0], 0, b[0], 0), this.removeMarkers(), this.editableDisabled || this.isHTML || this.options.editInPopup || this.$element.attr("contenteditable", !0), this.$element.focus())
        }
    ...
    }, $.Editable.prototype.placeMarker = function (a, b) {
        try {
            var c = a.cloneRange();
            c.collapse(b), c.insertNode($('<span id="marker-' + b + '">', document)[0]), c.detach()
        } catch (d) {}
    }, $.Editable.prototype.removeMarkers = function () {
        this.$element.find("#marker-true, #marker-false").remove()
        ...
        void 0 === a && (a = !0), a ? this.hideOtherEditors() : (this.closeImageMode(), this.imageMode = !1), this.$popup_editor.hide(), this.hidePopups(), this.hideDropdowns(), this.link = !1
    ...
    }, $.Editable.prototype.hidePopups = function () {
        this.hideBttnWrapper(), this.raiseEvent("hidePopups")
        ...
        this.$image_wrapper && (this.$element.attr("data-resize") || a || this.closeImageMode(), this.$image_wrapper.hide(), this.imageMode = !1)
        ...
        var a = this,
            ...
            c = function (b) {
                b.stopPropagation(), b.preventDefault(), a.link = !0, a.clearSelection(), a.removeMarkers(), a.selectionDisabled || ($(this).before('<span id="marker-true"></span>'), $(this).after('<span id="marker-false"></span>')), a.restoreSelectionByMarkers(), a.exec("createLink");
        ...
        this.addListener("hidePopups", this.hideLinkWrapper), this.isLink && this.options.linkText && this.$link_wrapper.on("mouseup keydown", "input#f-lt-" + this._id, $.proxy(function (a) {
            ...
            this.$bttn_wrapper.show(), this.hideLinkWrapper(), !this.options.inlineMode && !this.imageMode || this.isLink ? (this.hide(), this.restoreSelection()) : this.imageMode && this.showImageEditor()
        }, this))
    },
    function (a) {
